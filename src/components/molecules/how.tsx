      ...
      <div className="h-96 w-full content-center justify-center bg-minty">
        ...
        <div className="flex justify-between gap-2">
          <div className="border-1 mx-10 h-72 w-1/4 rounded-xl bg-greenish">
            ...
            <div className="w-fill z-50 mx-5 mt-40 h-16 content-end rounded-xl bg-minty"></div>
          </div>
          <div className="border-1 mx-10 h-72 w-1/4 rounded-xl bg-greenish">
            <p className="ml-4 mt-4">From the</p>
            <div className="w-fill z-50 mx-5 mt-40 h-16 content-end rounded-xl bg-minty"></div>
          </div>
          <div className="border-1 mx-10 h-72 w-1/4 rounded-xl bg-greenish">
            <p className="ml-4 mt-4">Other SIIIIIIIIIIIIIIIIIIIDE</p>
            <div className="w-fill z-50 mx-5 mt-40 h-16 content-end rounded-xl bg-minty"></div>
          </div>
        </div>
      </div>
